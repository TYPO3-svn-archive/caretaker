...
class tx_caretakerselenium extends t3lib_svbase implements tx_caretaker_TestService {
	var $prefixId = 'tx_caretakerselenium';		// Same as class name
	var $scriptRelPath = 'services/class.tx_caretakerselenium.php';	// Path to this script relative to the extension dir.
	var $extKey = 'caretaker_selenium';	// The extension key.
