...
class tx_caretakerselenium extends t3lib_svbase implements tx_caretaker_TestService {
	var $prefixId = 'tx_caretakersnmp';		// Same as class name
	var $scriptRelPath = 'services/class.tx_caretakersnmp.php';	// Path to this script relative to the extension dir.
	var $extKey = 'caretaker_snmp';	// The extension key.
